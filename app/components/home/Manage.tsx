...
const Manage = () => {
  return (
    <section className="px-10 py-16 flex flex-col-reverse justify-center items-center gap-10 lg:flex-row-reverse lg:px-48">
      <Image
        alt="muraajaco app"
      ...
      <div className=" flex flex-col items-start justify-start">
        <h1 className="font-Poppins text-center w-full text-3xl font-bold text-[#1A263D] lg:text-left md:text-4xl md:mb-3">
          Manage
        </h1>
